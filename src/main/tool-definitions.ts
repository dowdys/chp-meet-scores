    ...
    // --- Database tools ---
    {
      ...
      input_schema: {
        ...
        properties: {
          ...
          division_order: { type: 'string', description: 'Comma-separated divisions youngest-to-oldest. Provide this to ensure correct age ordering on the shirt. Query divisions after build if needed.' },
    ...
    },
    {
      ...
      input_schema: {
        ...
        properties: {
          ...
          division_order: { type: 'string', description: 'REQUIRED on first call (saved for reuse after). Comma-separated divisions youngest-to-oldest. Query divisions first: SELECT DISTINCT level, division FROM results ... ORDER BY level, division. Then order by age. The tool will REJECT shirt generation without this.' },
